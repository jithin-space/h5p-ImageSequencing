(function(ImageSequencing, EventDispatcher, $) {
   ...
   */
    ImageSequencing.Image = function(image,id,seqNumber,description) {
       ...
       */
        ...
        self.appendTo = function($container,size) {
            self.$dropper = $('<div class="columns" width="'+size[0]+'px" height="'+size[0]+'px" draggable="true"><header class="count" data-col-moves="0">moves:'+self.getMoves()+'</header><div>\
