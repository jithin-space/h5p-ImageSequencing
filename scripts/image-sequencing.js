...
H5P.ImageSequencing = (function(EventDispatcher, $, UI) {
   ...
   */
    ...
    var calculateScore = function(){
      ...
      feedbackMessage= getFeedbackMessage((score/level)*100); //get the feedback message based on the performance
    ...
    */
    ...
    self.attach = function($container) {
        ...
        if (level) {
            ...
            self.$submit = UI.createButton({title: 'Submit', click: function (event) { gameSubmitted(); },html:'Submit'});
